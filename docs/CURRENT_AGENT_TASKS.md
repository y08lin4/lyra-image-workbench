...
本文用于防止上下文压缩、并行 agent 和未提交改动导致任务遗失。当前最新口径以本页 `0. 2026-06-28 主代理拆分与回收台账` 为准；下方 2026-06-27 内容保留为历史归档，不再自动视为当前运行状态。需要查历史时看 `docs/current-round-task-report.md`、`docs/CURRENT_ROUND_AGENT_CONTROL.md` 和 Git 工作区实际改动。
